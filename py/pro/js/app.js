/**
 * Py Pro - Professional Python IDE
 */

class PythonIDE {
    constructor() {
        this.version = 'Pro v1.01';
        this.isReady = false;
    ...
    async _runStaticAnalysis() {
        ...
        const problems = await window.logiX.analyze(code);
...
Ctrl+N - 新建文件`);
     ...
     */
    _showAbout() {
        alert(`Py Pro - Professional Python IDE

版本: ${this.version}

基于Pyodide的专业Python编程环境。`);
    }
